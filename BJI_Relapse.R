...
p2<-ggplot(dataH, aes(x=Strain, y=Mean, fill=factor(Time, levels = order))) + geom_bar(colour="black", stat="identity", position='dodge', width=0.7)+theme_classic()+ geom_errorbar(aes(ymin=Mean-SD, ymax=Mean+SD), width=.2, position=position_dodge(0.7))+ geom_point(data=dataPH, aes(x=Strain, y=Point, fill=factor(Time, levels = order)), position=position_dodge(width=.7)) +scale_y_continuous(expand = c(0,0), limits = c(0,1.5)) + xlab("")+ylab("Relative hemolysis")+ scale_fill_manual(values=c("white",  "lightgrey",  "darkgrey"), name="")+ theme(text = element_text(size=15),strip.text = element_blank(),axis.text.x = element_text(angle = 45, hjust = 1),plot.margin=unit(c(0.2,0,1,0.5), "cm"))+ geom_hline(yintercept=1, linetype="dashed", color = "black")
...
#Biofilm formation
##I1-R1
data<-read.table("I1-R1_Biof_CV_mean.txt",header = T,sep = "\t")
dataP<-read.table("I1-R1_Biof_CV_points.txt",header = T,sep = "\t")
order=c("I1","R1","MG1655","TG1")

ggplot(data, aes(x=Group, y=Mean, fill=factor(Sample, levels = order))) + geom_bar(colour="black", stat="identity", position='dodge', width=0.7)+theme_classic()+ geom_errorbar(aes(ymin=pmax(0,Mean-SD), ymax=Mean+SD), width=.2, position=position_dodge(0.7))+ geom_point(data=dataP, aes(x=Group, y=OD, fill=factor(Sample, levels = order)), position=position_dodge(width=.7)) +scale_y_continuous(expand = c(0,0), limits = c(0,1.64)) + ylab(expression("OD"[570]))+ xlab("") + scale_fill_manual(values=c("firebrick4", "indianred3", "#D3D3D3", "#FFFFFF"), name="Strain")+ theme(text = element_text(size=15),axis.text.x=element_blank(),axis.ticks.x=element_blank())+facet_grid(.~Group,space = "free",scales = "free")
ggsave("I1-R1_PVC_PS.tiff",width=4,height = 5,device = "tiff",dpi = 700)
...
ggplot(dataCFU, aes(x=Group, y=Mean,fill=factor(Sample, levels = order))) + geom_bar(colour="black", stat="identity", position=position_dodge(), width=0.7)+theme_classic()+ geom_errorbar(aes(ymin=pmax(0,Mean-SD), ymax=Mean+SD), width=.2, position=position_dodge(0.7))+ geom_point(data=dataCFUp, aes(x=Group, y=cfu, fill=factor(Sample, levels = order)), position=position_dodge(width=.7)) + ylab("CFU / mL")+ xlab("") + scale_fill_manual(values=c("firebrick4", "indianred3", "#D3D3D3", "#FFFFFF"), name="Strain")+ theme(text = element_text(size=15),axis.text.x=element_blank(),axis.ticks.x=element_blank())+facet_grid(.~Group,space = "free",scales = "free") +scale_y_continuous(trans = "log",expand=c(0,0), breaks = c(0, 1e+02, 1e+04, 1e+06, 1e+08), limits = c(NA, 1e+10),position = "right")
ggsave("I1-R1_CFUlog.tiff",width=6,height = 5,device = "tiff",dpi = 700)


##I2-R2
data<-read.table("I2-R2_Biof_CV_mean.txt",header = T,sep = "\t")
dataP<-read.table("I2-R2_Biof_CV_points.txt",header = T,sep = "\t")
...
ggsave("I2-R2_PVC_PS.tiff",width=4,height = 5,device = "tiff",dpi = 700)
...
ggplot(dataCFU, aes(x=Group, y=Mean,fill=factor(Sample, levels = order))) + geom_bar(colour="black", stat="identity", position=position_dodge(), width=0.7)+theme_classic()+ geom_errorbar(aes(ymin=pmax(0,Mean-SD), ymax=Mean+SD), width=.2, position=position_dodge(0.7))+ geom_point(data=dataCFUp, aes(x=Group, y=cfu, fill=factor(Sample, levels = order)), position=position_dodge(width=.7)) + ylab("CFU / mL")+ xlab("") + scale_fill_manual(values=c("dodgerblue4", "dodgerblue2", "#D3D3D3", "#FFFFFF"), name="Strain")+ theme(text = element_text(size=15),axis.text.x=element_blank(),axis.ticks.x=element_blank())+facet_grid(.~Group,space = "free",scales = "free") +scale_y_continuous(trans = "log",expand=c(0,0), breaks = c(0, 1e+02, 1e+04, 1e+06, 1e+08), limits = c(NA, 1e+10),position = "right")
ggsave("I2-R2_CFUlog.tiff",width=6,height = 5,device = "tiff",dpi = 700)


##I3-R3
data<-read.table("I3-R3_Biof_CV_mean.txt",header = T,sep = "\t")
dataP<-read.table("I3-R3_Biof_CV_points.txt",header = T,sep = "\t")
...
ggsave("I3-R3_PVC_PS.tiff",width=4,height = 5,device = "tiff",dpi = 700)
...
ggplot(dataCFU, aes(x=Group, y=Mean,fill=factor(Sample, levels = order))) + geom_bar(colour="black", stat="identity", position=position_dodge(), width=0.7)+theme_classic()+ geom_errorbar(aes(ymin=pmax(0,Mean-SD), ymax=Mean+SD), width=.2, position=position_dodge(0.7))+ geom_point(data=dataCFUp, aes(x=Group, y=cfu, fill=factor(Sample, levels = order)), position=position_dodge(width=.7)) + ylab("CFU / mL")+ xlab("") + scale_fill_manual(values=c("seagreen4", "seagreen3", "#D3D3D3", "#FFFFFF"), name="Strain")+ theme(text = element_text(size=15),axis.text.x=element_blank(),axis.ticks.x=element_blank())+facet_grid(.~Group,space = "free",scales = "free") +scale_y_continuous(trans = "log",expand=c(0,0), breaks = c(0, 1e+02, 1e+04, 1e+06, 1e+08), limits = c(NA, 1e+10),position = "right")
ggsave("I3-R3_CFUlog.tiff",width=6,height = 5,device = "tiff",dpi = 700)
...
ggplot(data, aes(x=Strain, y=Mean, fill=Strain)) + geom_bar(colour="black", stat="identity", position='dodge', width=0.7)+theme_classic()+ geom_errorbar(aes(ymin=Mean-SD, ymax=Mean+SD), width=.2, position=position_dodge(0.7))+ geom_point(data=datPoint, aes(x=Strain, y=Point, fill=Strain), position=position_dodge(width=.7)) +scale_y_continuous(expand = c(0,0), limits = c(0,1.2)) + ylab("Normalized serum survival (%)")+ scale_fill_manual(values=c("dodgerblue4", "white", "grey", "dodgerblue2"), name="Strain")+ theme(text = element_text(size=20),legend.position ="none",axis.text.x = element_text(angle = 45, hjust = 1))+ geom_hline(yintercept=1, linetype="dashed", color = "black")+xlab("")+ scale_x_discrete(limits=c("R2","I2","I2∆afaBCDE","I2∆yadA-like"))
